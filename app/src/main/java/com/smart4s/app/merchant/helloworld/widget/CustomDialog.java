package com.smart4s.app.merchant.helloworld.widget;
...
public class CustomDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTvCancel = this.<TextView>findViewById(R.id.tv_cancle);
        mTvConfirm = this.<TextView>findViewById(R.id.tv_confim);
